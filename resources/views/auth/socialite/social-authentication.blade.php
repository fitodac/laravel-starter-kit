<div class="space-y-4">
	...
	<a href="{{ route('socialite.redirect', 'google') }}"
		class="border border-gray-600 p-2.5 flex items-center justify-center gap-x-2 transition-colors rounded-lg hover:bg-gray-400/10">
		...
		<span class="text-sm font-medium">{{ __("Sign in with Google") }}</span>
	</a>
</div>